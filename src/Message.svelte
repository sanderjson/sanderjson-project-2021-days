<script>
  let quitStart = new Date(2020, 11, 12);
  let today = new Date();
  ...
  let quitTime = todayFixed - quitStart;
  let quitDay = (quitTime / 1000 / 3600 / 24).toFixed(0);
</script>
...
<div class="absolute inset-0 flex justify-center items-center">
  <div class="container my-8 mx-16 bg-white rounded-lg shadow-xl max-w-screen-sm transition-all duration-150">
    <section class="py-8 px-4 sm:py-10 sm:px-8">
      ...
      <h1 class="text-base sm:text-3xl font-bold pt-3">Hey Cassy!</h1>
